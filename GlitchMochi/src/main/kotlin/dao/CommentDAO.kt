...
class CommentDAO : GenericDAO {
    ...
    // Pega todos os resultados obtidos dentro do banco para o id solicitado dentro de Comment
    override fun getOne(id: Int): Comments {
        ...
        val resultSet = connection.executeQuery("SELECT * FROM Comment WHERE commentID = ${id};")
